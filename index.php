  ...
  <header>
    <nav>
      <ul>
        <li>
          <a href="index.php"
            ><i class="fab fa-f368"></i
            ><img src="images/watermelon.png" style="width: 40px"
          /></a>
        </li>
      ...
      <div class="footer-main">
        ...
        <div class="footer-copyright">
          ...
          <div class="footer-lang">
            <div class="circle">
              <img
                src="https://images-na.ssl-images-amazon.com/images/I/21ebY7rg4aL._AC_.jpg"
              />
            </div>
            <p>ไทย</p>
            <div class="vr"></div>
